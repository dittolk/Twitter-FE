...
function LoginBox() {
    ...
    const handleSubmitLogin = async (data_input_property) => {
        try{
            const response = await axios.get(`http://localhost:2000/users?email=${data_input_property.email}&password=${data_input_property.password}`, data_input_property)
    ...
    return(
        ...
        <Modal
            ...
            <ModalContent>
                <Formik
                    initialValues={{name:"", username:"", email: "", password: "", password_confirmation: "", bio:"Hey there! I'm using twitter.", followers_list: ["Mark Zuckeberg", "Joe Biden"], following_list: ["Mark Zuckeberg"]}}
